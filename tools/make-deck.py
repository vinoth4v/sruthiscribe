...
def build(path):
    ...
    stat(s, Inches(0.9), Inches(1.95), Inches(2.7), "79.3%", "svara accuracy\n(label + octave)")
    stat(s, Inches(3.85), Inches(1.95), Inches(2.7), "82.4%", "raw pitch accuracy", TEAL)
    stat(s, Inches(6.8), Inches(1.95), Inches(2.7), "2.7%", "octave error rate", TEAL)
    stat(s, Inches(9.75), Inches(1.95), Inches(2.65), "7.6¢", "tonic (sruthi) error", TEAL)
